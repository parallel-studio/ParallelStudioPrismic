...
export async function generateMetadata({ params }: GenerateMetadataParams) {
    ...
    const metaTitle = page.data.meta_title ?? page.data.title;
    const title = `${metaTitle}${hasClientData(page.data.client) ? ` for ${page.data.client.data.name}` : ""} | ${asText(settings.data.siteTitle)}`;
