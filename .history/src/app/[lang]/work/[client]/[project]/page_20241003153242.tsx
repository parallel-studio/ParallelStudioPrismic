...
export async function generateMetadata({ params }: GenerateMetadataParams) {
    ...
    const metaTitle = page.data.meta_title ??  `${page.data.title}${hasClientData(page.data.client) ? ` - ${page.data.client.data.name}`;
    const title = `${metaTitle}${hasClientData(page.data.client) ? ` - ${page.data.client.data.name}` : ""} | ${asText(settings.data.siteTitle)}`;
