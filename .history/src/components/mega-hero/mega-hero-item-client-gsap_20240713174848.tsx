        ...
        (
            ...
            if (otherItem !== itemContainer.current) {
                otherItem.style.filter =
                    "/_next/static/media/filter.9412d01f.svg#whiteBackgroundFilter";
                otherItem.classList.add(styles.filter);
            }
        });
    };
        ...
        >
            <svg width="230" height="120" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle
                    ...
                    r="50"
                    fill="green"
                    filter="url(#whiteBackgroundFilter)"
                />
            </svg>
