...
export const useMegaHeroMotion = ({
    ...
    const xProgress = useSlide(scrollYProgress, 2300).getPrevious();
    ...
    useEffect(() => {
        if (carousel) {
            ...
            items.forEach((item, index) => {
                const carouselItem = item as HTMLElement;
                carousel.style.transform = `translateX(${xProgress}px)`;
            });

            console.log(carousel.querySelectorAll(".carousel_item"));
        }
