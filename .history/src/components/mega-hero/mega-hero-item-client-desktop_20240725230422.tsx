...
export const MegaHeroItemClientDesktop: FC<MegaHeroItemProps<HTMLElement>> = ({
    ...
    //             start: "left 45%",
    //             // end: "right 80%",
    //             end: "right 100px", // Adjust this value as needed
    //             // start: "left 120px", // Adjust this value as needed
    ...
    return (
        <li
            className={clsx(styles.item, className, tabletActive ? styles.darken : undefined, "carousel_item")}
