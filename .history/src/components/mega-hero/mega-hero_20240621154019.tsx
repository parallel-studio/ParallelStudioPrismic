        ...
        const handleWheel = (e: WheelEvent) => {
            if (isInView && carousel) {
                ...
                gsap.to(carousel, {
                    ...
                    duration: 0.1, // Adjust the duration for more/less lag
    ...
    useEffect(() => {
        ...
        if (carousel) {
            ...
            const handleManualScroll = () => {
                animationStops(); // Stop the animation if there's a manual scroll
            };
            ...
            return () => {
                carousel.removeEventListener("scroll", handleManualScroll);
