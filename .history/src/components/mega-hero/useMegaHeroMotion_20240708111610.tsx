...
export const useMegaHeroMotion = ({}: UseMegaHeroProps) => {
    ...
    useIsomorphicLayoutEffect(() => {
        ...
        // let scrollSpeed = 0.5; // Ajustez la vitesse ici (pixels par intervalle)
        // let interval = 1; // Ajustez l'intervalle ici (en millisecondes)

        let scrollSpeed = 1; // Ajustez la vitesse ici (pixels par intervalle)
        let interval = 4; // Ajustez l'intervalle ici (en millisecondes)
