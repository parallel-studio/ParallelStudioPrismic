                ...
                if (currentScrollPosition > 0) {
                    gsap.to(carousel, {
                        scrollTo: {
                            ...
                            autoKill: true,
                            onAutoKill: () =>
                                setTimeout(animationStarts, 10000), // Restart the animation with a slight delay
                        },
                        duration:
                    ...
                    // If the scroll position is at 0, start the animation without jumping
                    gsap.to(carousel, {
                        scrollTo: {
                            x: "max",
                            autoKill: true,
                            onAutoKill: () =>
                                setTimeout(animationStarts, 10000),
                        },
