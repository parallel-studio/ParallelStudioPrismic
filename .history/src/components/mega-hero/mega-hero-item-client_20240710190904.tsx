...
export const MegaHeroItemClient: FC<MegaHeroItemProps> = ({
    ...
    const { activeLayout: isMobileLayoutActive } = useLayout();
    ...
    const offset = isMobileLayoutActive ? 0 : -distanceToScroll - END_OF_SCROLL;

    const scrollXProgress = useTransform(scrollYProgress, [0, 1], [0, offset]);
