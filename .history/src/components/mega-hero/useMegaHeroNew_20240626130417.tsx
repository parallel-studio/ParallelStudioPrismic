...
export const useMegaHeroNew = ({ container }: UseMegaHeroProps) => {
    ...
    const autoScrollStarts = useCallback(() => {
        ...
        if (carousel && carouselItems) {
            ...
            gsap.to(carouselItems, {            const currentX = gsap.getProperty(carouselItems[0], "x") as number            const currentX = gsap.getProperty(carouselItems[0], "x") as number            const currentX = gsap.getProperty(carouselItems[0], "x") as number            const currentX = gsap.getProperty(carouselItems[0], "x") as number            const currentX = gsap.getProperty(carouselItems[0], "x") as number            const currentX = gsap.getProperty(carouselItems[0], "x") as number            const currentX = gsap.getProperty(carouselItems[0], "x") as number            const currentX = gsap.getProperty(carouselItems[0], "x") as number            const currentX = gsap.getProperty(carouselItems[0], "x") as number            const currentX = gsap.getProperty(carouselItems[0], "x") as number            const currentX = gsap.getProperty(carouselItems[0], "x") as number            const currentX = gsap.getProperty(carouselItems[0], "x") as number
                translateX:             const currentX = gsap.getProperty(carouselItems[0], "x") as number            const currentX = gsap.getProperty(carouselItems[0], "x") as number            const currentX = gsap.getProperty(carouselItems[0], "x") as number            const currentX = gsap.getProperty(carouselItems[0], "x") as number            const currentX = gsap.getProperty(carouselItems[0], "x") as number            const currentX = gsap.getProperty(carouselItems[0], "x") as number            const currentX = gsap.getProperty(carouselItems[0], "x") as number            const currentX = gsap.getProperty(carouselItems[0], "x") as numberurrentX - 150;
                },
