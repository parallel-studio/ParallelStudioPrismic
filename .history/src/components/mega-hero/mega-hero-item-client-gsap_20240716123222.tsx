...
export const MegaHeroItemClientGsap: FC<MegaHeroItemProps> = ({
    ...
    useEffect(() => {
        ...
        Observer.create({
            target: video, // can be any element (selector text is fine)
            type: "pointer", // comma-delimited list of what to listen for ("wheel,touch,scroll,pointer")
            onHover: undimVideo,
            onHoverEnd: dimVideo,
        });
        // if (activeItem && !itemIsActive) {
        //     // animate(video, { opacity: 0.7 }, { duration: 0.5 });
        //     gsap.to(video, {
        //         opacity: 0.7,
        //         duration: 0.5,
        //         ease: "power1.out",
        ...
        // } else {
        //     // animate(video, { opacity: 1 }, { duration: 0.5 });
        //     gsap.to(video, {
        //         opacity: 1,
        //         duration: 0.2,
        //         ease: "power1.out",
        //     });
        // }
    }, [itemIsActive, activeItem, itemContainer, undimVideo, dimVideo]);
    ...
    return (
        ...
        >
            ...
            <div style={{ aspectRatio }} className="carousel_video">
                {project &&
