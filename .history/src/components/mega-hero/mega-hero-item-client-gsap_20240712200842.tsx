...
export const MegaHeroItemClientGsap: FC<MegaHeroItemProps> = ({
    ...
    useEffect(() => {
        ...
        const placeholderWidth =
            document.querySelector(".carousel_placeholder")?.clientWidth ?? 500;
        ...
        // elementContainer.addEventListener("wheel", onCarouselWheel);

        // const draggableInstance = Draggable.create(elementContainer, {
        //     type: "x",
        //     inertia: true,
        //     bounds: { minX: 0, maxX: -offset }, // Adjust according to your carousel's width
        //     onDrag: function () {
        //         // Optional: Callback for additional actions during drag
        //         const currentPosition = this.x;
        //         gsap.to(element, { x: currentPosition, duration: 0 });
        //     },
        // });

        return () => {
            window.removeEventListener("wheel", onBodyWheel);
            // elementContainer.removeEventListener("wheel", onCarouselWheel);
