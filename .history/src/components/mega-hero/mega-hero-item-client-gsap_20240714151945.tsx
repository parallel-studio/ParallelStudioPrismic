...
export const MegaHeroItemClientGsap: FC<MegaHeroItemProps> = ({
    ...
    useEffect(() => {
        ...
        const onBodyWheel: Observer.ObserverCallback = (e) => {
            ...
            const sensitivity = e.isDragging ? 0.5 : 0.5;
            const duration = e.isDragging ? 0.3 : 0.5;
            if (e.deltaY) {
        ...
        const onDrag: Observer.ObserverCallback = (e) => {
            console.log(e);
            // if (e.deltaY) {
    ...
    }, [container, itemContainer, isMobileLayoutActive, calculateSizes]);
