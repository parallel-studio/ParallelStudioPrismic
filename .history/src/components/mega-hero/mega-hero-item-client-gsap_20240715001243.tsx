...
export const MegaHeroItemClientGsap: FC<MegaHeroItemProps> = ({
    ...
    const [elementContainerClientWidth, setElementContainerClientWidth] =
        useState(elementContainer?.clientWidth);
    ...
    useEffect(() => {
        ...
        window.addEventListener("resize", () => {
            if (element) setElementContainerClientWidth(element.clientWidth);
            gsap.killTweensOf(element);
            gsap.killTweensOf(container);
            gsap.killTweensOf(itemContainer);
