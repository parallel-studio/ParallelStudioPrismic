...
export const useMegaHeroSwiper = ({
    ...
    useEffect(() => {
        ...
        if (carousel && swiper) {
            ...
            window.addEventListener("onmouseenter", stopAnimation);
            window.addEventListener("onmouseleave", startAnimation);

            return () => {
                window.removeEventListener("onmouseenter", stopAnimation);
                window.removeEventListener("onmouseleave", startAnimation);
            };
        }
