...
export const CarouselAi: FC<CarouselAiProps> = ({ items }) => {
    ...
    useEffect(() => {
        ...
        // Initialize GSAP Draggable for the carousel
        const draggableInstance = Draggable.create(element, {
            type: "x",
            inertia: true,
            bounds: { minX: 0, maxX: 300 }, // Adjust according to your carousel's width
            onDrag: function () {
        ...
        return () => {
            // Cleanup: Kill the Draggable instance on component unmount
