...
export const useMegaHeroMotion = ({}: UseMegaHeroProps) => {
    ...
    useEffect(() => {
        ...
        if (hoverElement) {
            let scrollSpeed = isMobileLayoutActive ? 0.5 : 1; // Ajustez la vitesse ici (pixels par intervalle)
            let interval = isMobileLayoutActive ? 60 : 30; // Ajustez l'intervalle ici (en millisecondes)
