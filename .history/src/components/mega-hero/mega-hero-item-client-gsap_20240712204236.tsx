...
export const MegaHeroItemClientGsap: FC<MegaHeroItemProps> = ({
    ...
    const [placeHolderWidth, setPlaceHolderWidth] = useState(500);
    ...
    useEffect(() => {
        const handleResize = () => {
            ...
            if (scrollWidth) setPlaceHolderWidth(scrollWidth);
        };
    ...
    useEffect(() => {
        const handleResize = () => {
            placeholderWidth =
                document.querySelector(".carousel_placeholder")?.clientWidth ??
                500;
        };
