        ...
        if (itemContainer.current && carousel.current) {
            ScrollTrigger.create({
                ...
                onEnterBack: () => {
                    ...
                    console.log("Element is back in view");
                },
                onLeaveBack: () => {
