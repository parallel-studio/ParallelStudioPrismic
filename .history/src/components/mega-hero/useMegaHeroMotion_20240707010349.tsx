...
export const useMegaHeroMotion = ({}: UseMegaHeroProps) => {
    ...
    useEffect(() => {
        ...
        if (hoverElement) {
            let scrollSpeed = isMobileLayoutActive ? 0.2 : 1; // Ajustez la vitesse ici (pixels par intervalle)
            let interval = isMobileLayoutActive ? 50 : 30; // Ajustez l'intervalle ici (en millisecondes)
