...
export const useMegaHeroMotion = ({}: UseMegaHeroProps) => {
    ...
    useIsomorphicLayoutEffect(() => {
        ...
        let scrollSpeed = isMobileLayoutActive ? 1 : 12; // Ajustez la vitesse ici (pixels par intervalle)
        let interval = isMobileLayoutActive ? 5 : 120; // Ajustez l'intervalle ici (en millisecondes)
