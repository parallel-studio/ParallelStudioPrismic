...
type GalleryPropsBase<T extends ElementType> = {
    children: ReactNode;
    as?: T;
    gap?: GalleryGap;
...
type GalleryPropsSmartLayout = {
    layoutType: "smart";
    smartItems: { width: number; height: number }[];
};

type GalleryPropsNonSmartLayout = {
    layoutType?: Exclude<GalleryClassNames, "smart">;
};

type GalleryProps<T extends ElementType> =
    | (GalleryPropsBase<T> & GalleryPropsSmartLayout)
    | (GalleryPropsBase<T> & GalleryPropsNonSmartLayout);
