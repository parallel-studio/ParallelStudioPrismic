...
export type SmartGridBreakpoints =
    | Record<Partial<Layout>, { columns: number; gutter: Gutter }>
    | {};
...
export const SmartGrid: FC<SmartGridProps<ElementType>> = ({
    ...
    const currentBreakpoint = activeLayout
        ? breakpoints[activeLayout]
        : breakpoints["desktop"];
    const gutterSize = getSize(currentBreakpoint.gutter);
    const columns = currentBreakpoint.columns;
