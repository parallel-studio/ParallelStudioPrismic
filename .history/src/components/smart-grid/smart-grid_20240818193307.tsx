...
const DATA_SMART_WIDTH = "data-smart-width";
const DATA_SMART_HEIGHT = "data-smart-height";
...
const getSmartTable = (nodes: NodeList, columns: number): SmartTable => {
    ...
    nodes.forEach((child) => {
        ...
        if (element) {
            const dataWidth = element?.getAttribute(DATA_SMART_WIDTH);
            const width = dataWidth ? parseInt(dataWidth) : element.clientWidth;
            const dataHeight = element?.getAttribute(DATA_SMART_HEIGHT);
