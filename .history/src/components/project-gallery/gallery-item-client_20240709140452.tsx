...
type GalleryItemClientProps = {
    ...
    muxData_DefaultVideo?: ReturnTypeGetMuxBlurUp & { playbackId?: string, playerInitTime?: number};
    muxData_AlternativeVideo?: ReturnTypeGetMuxBlurUp & { playbackId?: string, playerInitTime?: number };
};
