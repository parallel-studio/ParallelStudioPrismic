...
type GalleryItemClientProps = {
    ...
    muxData_DefaultVideo: ReturnTypeGetMuxBlurUp;
    muxData_AlternativeVideo: ReturnTypeGetMuxBlurUp;
};
...
export const GalleryItemClient: FC<GalleryItemClientProps> = ({
    ...
    if (hasProjectData(project) && hasClientData(project.data.client)) {
        ...
        const smallestAspectRatioVideo =
            muxData_DefaultVideo?.aspectRatio <
