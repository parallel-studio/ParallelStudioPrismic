...
export const Image: FC<ImageProps> = ({ slice }) => {
    ...
    if (variation === "smart") {
        ...
        const breakpoints = {
            mobile: layouts.find((layout) => layout.breakpoint === "mobile"),
            tablet: layouts.find((layout) => layout.breakpoint === "desktop"),
            desktop: layouts.find((layout) => layout.breakpoint === "desktop"),
        };
