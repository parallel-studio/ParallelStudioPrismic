...
import { ImageSliceVariation } from "@/types";
...
const imageVariants: ImageVariantsProps = {
  ...
  native: { items: 1, className: "default" },
};
          ...
          if (isFilled.image(item.image)) {
            return (
              <ImageComponent
                ...
                data-smart-width={item.image.dimensions.width}
                data-smart-height={item.image.dimensions.height}
              />
            );
          }
        })}
